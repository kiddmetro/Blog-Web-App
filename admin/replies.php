        ...
        <nav class="dashboard-navbar">
            ...
            <div>
                <div class="d-flex pb-2 " >
                    ...
                    <a class="px-3" href="comment.php" >Replies</a>
                </div>
           ...
           <?php include('message.php'); ?>
              <table class="">
                ...
                <?php 
                  ...
                  {
                      foreach($query_run as $replydata)
                      {
                        $replyAt = strtotime($replydata['reply_date']); // Convert the created_at timestamp 
                          $formattedDate = date("M j, Y", $replyAt);
                ?>
                  <tr>
                    <th scope="row"><?= $replydata['reply_id']; ?></th>
                    <td> <?=$replydata['comment_id'];?></td>
                    <td> <?=$replydata['blog_id'];?></td>
                    <td><?=$replydata['user_id'];?></td>
                    <td> <?=$replydata['username'];?></td>
                    ...
                    <td>
                      <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                          ...
                          <form action="replyAction/delete.php" method="POST">
                            <button type="submit" name="delete_reply" value="<?=$replydata['reply_id'];?>" class="btn btn-transparent btn-sm dropdown-item text-danger">Delete</button>
                          </form>
                        </ul>
                      </div>
                    </td>
